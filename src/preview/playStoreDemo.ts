...
export const PLAY_STORE_DEMO_FEED_POSTS: FeedPost[] = [
  {
    ...
    userPhotoURL: NEIGHBORS.jordan.photo,
    neighborhood: NEIGHBORS.jordan.neighborhood,
    text: 'Porch box is out — towels and a small lamp if anyone can use them tonight.',
    imageUrls: ['/play-store-demo/porch-box.jpg'],
    status: 'active',
    createdAt: hoursAgo(3),
    updatedAt: hoursAgo(3),
  },
  {
    id: 'demo-feed-cuttings',
    userId: NEIGHBORS.avery.uid,
    userDisplayName: NEIGHBORS.avery.name,
    userPhotoURL: NEIGHBORS.avery.photo,
    neighborhood: NEIGHBORS.avery.neighborhood,
    text: 'Spider plant cuttings rooted and ready. Comment if you want one saved.',
    imageUrls: ['/play-store-demo/plants.jpg'],
    status: 'active',
  ...
  },
  {
    ...
    userPhotoURL: NEIGHBORS.sam.photo,
    neighborhood: NEIGHBORS.sam.neighborhood,
    text: 'Oak Park checking in — dropping a stack of picture books this afternoon.',
    imageUrls: [],
    status: 'active',
...
export const PLAY_STORE_DEMO_FEED_REACTIONS: FeedPostReaction[] = [
  { postId: 'demo-feed-porch', userId: NEIGHBORS.casey.uid, emoji: '🥹', createdAt: hoursAgo(2.5) },
  { postId: 'demo-feed-porch', userId: NEIGHBORS.sam.uid, emoji: '🥹', createdAt: hoursAgo(2.4) },
  { postId: 'demo-feed-cuttings', userId: NEIGHBORS.jordan.uid, emoji: '🥺', createdAt: hoursAgo(8) },
];

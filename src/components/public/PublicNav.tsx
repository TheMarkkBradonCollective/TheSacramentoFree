    ...
    <header className={`sticky top-0 z-50 sbn-glass-nav sbn-safe-top ${newspaper ? 'tsf-section-bar' : ''}`}>
      ...
      >
        <button
          ...
          aria-label="TheSacramentoFree home"
          ...
          <BrandLogo
            imgClassName={
              newspaper
                ...
                : 'h-9 w-9 object-contain shrink-0 bg-transparent'
            }
          />
        </button>
      ...
      {menuOpen && (
        <nav
          className={`tsf-section-index lg:hidden border-t border-app px-4 py-3 flex flex-col gap-1 ${

...
import { FEATURE_APP_UPDATES } from './changelogFeatureUpdates';
...
— Mark`,
  ...
  },
  {
    ...
    body: 'Go Get pickup coordination, smarter notifications with quiet hours, smoother GPS navigation, and feed engagement stats.',
    detail: `WHAT NEIGHBORS SEE
TheSacramentoFree, 0.2.0 (56): pickup coordination, notifications, navigation, and engagement.

• Go Get — ring, schedule, Meet handoffs, and dual-travel trade Meet sessions
• Notifications — priorities, dedup, quiet hours, and listing view alerts
• GPS navigation — smoother live heading for Go Get and map routes
• Feed engagement — view counts on posts and listings, event votes, chat read receipts
• Staff neighbor chat tools restored in coordination threads
• Package stays org.sacramentobuynothing.app — your account is unchanged
• Opt in on closed testing if you have not yet: ${PLAY_CLOSED_TESTING_URL}
...
— Mark`,
  ...
  },
  {
    ...
    date: '2026-08-25',
    title: 'TheSacramentoFree — beta v0.2.0.0055',
    body: 'Restored the original Sacramento green 3D hands logo on the website, Install app, and Android home screen.',
    detail: `WHAT NEIGHBORS SEE
TheSacramentoFree, 0.2.0 (55): the original green rounded-square logo is back.
...
— Mark`,
    ...
    directorTitle: DIRECTOR_TITLE,
    postedByUserId: CHANGELOG_AUTHOR_UID,
    createdAt: APK_0055_AT,
    updatedAt: APK_0055_AT,
  },
  {
    id: '2026-08-25_apk-0054',
    date: '2026-08-25',
    title: 'TheSacramentoFree — beta v0.2.0.0054',
    body: 'Cleaner app icon — no green fringe or bleeding around the hands artwork on the site or your home screen.',
    detail: `WHAT NEIGHBORS SEE
TheSacramentoFree, 0.2.0 (54): sharper Sacramento green icon on web and Android.

• Logo edges are clean — no green smear or halo around the hands
• Homepage logo no longer sits on a green glow behind it
• Android install and home-screen icons use a proper safe-zone inset
• Same sign-in, listings, map, chat, and notifications
• Package stays org.sacramentobuynothing.app — your account is unchanged
• Opt in on closed testing if you have not yet: ${PLAY_CLOSED_TESTING_URL}
...
— Mark`,
    ...
    directorTitle: DIRECTOR_TITLE,
    postedByUserId: CHANGELOG_AUTHOR_UID,
    createdAt: APK_0054_AT,
    updatedAt: APK_0054_AT,
  },
  {
    id: '2026-08-25_apk-0053',
    date: '2026-08-25',
    title: 'TheSacramentoFree — beta v0.2.0.0053',
    body: 'Home-screen icon now matches the Sacramento green logo on the website — no more white box behind the hands.',
    detail: `WHAT NEIGHBORS SEE
TheSacramentoFree, 0.2.0 (53): Sacramento green squircle on your phone and on the site.

• Home-screen icon matches the website — Sacramento green with 3D hands
...
— Mark`,
  ...
  },
  {
    ...
    body: 'Classic app layout with a black-and-white look. Same community, same account — still TheSacramentoFree.',
    detail: `WHAT NEIGHBORS SEE
TheSacramentoFree, 0.2.0 (52): original layout restored with black-and-white styling.
...
— Mark`,
  ...
  },
  {
    ...
    detail: `WHAT NEIGHBORS SEE
TheSacramentoFree, 0.2.0 (51): same app, tighter fit.
...
/** Canonical app_updates seed — feature posts (Updates tab) plus APK posts (News). */
export const SEEDED_APP_UPDATES: SeededAppUpdate[] = [...FEATURE_APP_UPDATES, ...APK_APP_UPDATES];

...
- Facebook ad pack: `npm run facebook:promo` → 30-second `ad-portrait.mp4` + the same Play Console phone screenshots (`01-home.png` … `16-goget-arrived.png`) in `public/downloads/facebook-promo.zip`
